function [sd] = Test_single_MaxCut(r, field, model)
%This script runs an experimental instance using a real psd matrix 
%obtained from a max-cut problem solver. See our reference paper 
%for more details.
...
dataname = ['data/MaxCut.mat'];

if ~exist(dataname,'file')
    error(['Data file not found: Please first run ',...  
    '''CreateData_MaxCut.m'' file to generate the dataset.']);
end
load(dataname)
