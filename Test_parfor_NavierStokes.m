function [dummy] = Test_parfor_NavierStokes(r,type,field,model,MonteCarloNum)
...
parfor tt = 1:MonteCarloNum
    MCresults{tt} = Test_single_NavierStokes(r,type,field, model);
end

name = ['r',num2str(r),'_',type,'_',field,'_',model,'/'];
