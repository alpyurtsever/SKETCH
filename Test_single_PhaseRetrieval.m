function [sd] = Test_single_PhaseRetrieval(r, field, model)
%This script runs an experimental instance using a complex psd matrix 
%obtained from a real-world phase retrieval application. See our reference 
